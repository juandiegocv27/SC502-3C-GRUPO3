    ...
    <div class="graficos">
        <h1 class="title_grafico">Materia mas escogida</h1>
        <section class="container_grafico">
            <div class="grafico">
                <div class="container_leyenda">
                    <span class="leyenda_all">
                        <span class="color_rojo"></span>
                        <p class="matematicas">80% matematicas</p>
                    </span>
                    <span class="leyenda_all">
                        <span class="color_azul"></span>
                        <p class="matematicas">20% Ingles</p>
                    </span>
                    <p class="total">Total: 50,000</p>
                </div>
            ...
            <div class="d-flex justify-content-center ">
                ...
                <div class="col-md-4 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-white-50 mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Preguntas
                            Frecuentes</a>
