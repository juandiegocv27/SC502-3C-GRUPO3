        ...
        <div class="row">
            <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100" src="/build/img/alumnos.png" style="object-fit: cover;">
                </div>
            </div>
            <div class="col-lg-7">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 my-5 pt-5 pb-lg-5">
                ...
                <p class="mb-4 pb-2">Más de 5000 jóvenes costarricenses y cerca de ocho millones de estudiantes alrededor del mundo ya son parte de esta experiencia académica. Forma parte tu también de este selecto grupo de soñadores entusiastas que ponen a prueba su razonamiento. Canguro Matemático es una actividad interesante que estimula el pensamiento y que además te ayuda a crecer en conocimientos</p>
                <div class="d-flex mb-3">
                    ...
                    <div class="mt-n1">
                        ...
                        <p>Enfócate en las habilidades que necesitas reforzar, prepárate para alcanzar tus objetivos con profesores particulares</p>
                    </div>
                </div>
                <div class="d-flex mb-3">
                    ...
                    <div class="mt-n1">
                        ...
                        <p>Encuentra profesores particulares certificados, verificamos y confirmamos cuidadosamente el perfil de cada profesor</p>
                    </div>
                </div>
                <div class="d-flex">
                    ...
                    <div class="mt-n1">
                        <h4>Clases Online</h4>
                        <p class="m-0">Toma clases particulares online en un horario que se adapte a tu apretada agenda</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-5" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100" src="/build/img/feature.jpg" style="object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid px-0 py-5">
    <div class="row mx-0 justify-content-center pt-5">
        <div class="col-lg-6">
            <div class="section-title text-center position-relative mb-4">
                <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Nuestras Tutorias</h6>
                <h1 class="display-4">Nuevas Tutorias</h1>
            </div>
        </div>
    </div>
    <div class="owl-carousel courses-carousel">
        ...
        <div class="courses-item position-relative">
            <img class="img-fluid" src="/build/img/courses-5.jpg" alt="">
            <div class="courses-text">
                <h4 class="text-center text-white px-3">Web design & development courses for beginners</h4>
                <div class="border-top w-100 mt-3">
                    <div class="d-flex justify-content-between p-4">
...
<div class="container-fluid py-5">
    <div class="container py-5">
        <div class="section-title text-center position-relative mb-5">
            ...
            <h1 class="display-4">Conozca Nuestros Profesores</h1>
        </div>
        <div class="owl-carousel team-carousel position-relative" style="padding: 0 30px;">
            <div class="team-item">
                <img class="img-fluid w-100" src="/build/img/team-1.jpg" alt="">
            ...
            <div class="team-item">
                <img class="img-fluid w-100" src="/build/img/team-2.jpg" alt="">
                <div class="bg-light text-center p-4">
                    <h5 class="mb-3">Instructor Name</h5>
                    <p class="mb-2">Web Design & Development</p>
                    <div class="d-flex justify-content-center">
            ...
            <div class="team-item">
                <img class="img-fluid w-100" src="/build/img/team-3.jpg" alt="">
                <div class="bg-light text-center p-4">
                    <h5 class="mb-3">Instructor Name</h5>
                    <p class="mb-2">Web Design & Development</p>
                    <div class="d-flex justify-content-center">
            ...
            <div class="team-item">
                <img class="img-fluid w-100" src="/build/img/team-4.jpg" alt="">
                <div class="bg-light text-center p-4">
                    <h5 class="mb-3">Instructor Name</h5>
                    <p class="mb-2">Web Design & Development</p>
                    <div class="d-flex justify-content-center">
        ...
        <div class="row align-items-center">
            <div class="col-lg-5 mb-5 mb-lg-0">
                <div class="section-title position-relative mb-4">
                    ...
                    <h1 class="display-4">Opiniones de Nuestros Estudiantes</h1>
                </div>
                <p class="m-0">La opinión de nuestros estudiantes es muy importante para nosotros porque nos permite mejorar la calidad de nuestras tutorias.
                </p>
            </div>
            <div class="col-lg-7">
                <div class="owl-carousel testimonial-carousel">
                    <div class="bg-white p-5">
                        ...
                        <p>Excelente formación. Grandes profesionales. Sin duda, realizare otra tutoria </p>
                        <div class="d-flex flex-shrink-0 align-items-center mt-4">
                            <img class="img-fluid mr-4" src="/build/img/testimonial-2.jpg" alt="">
                            <div>
                                <h5>Steven Araya</h5>
                            </div>
                        </div>
                    ...
                    <div class="bg-white p-5">
                        <i class="fa fa-3x fa-quote-left text-primary mb-4"></i>
                        <p>Curso bien estructurado, con ejemplos prácticos fáciles de seguir y atención precisa de los tutores si surge cualquier duda.</p>
                        <div class="d-flex flex-shrink-0 align-items-center mt-4">
                            <img class="img-fluid mr-4" src="/build/img/testimonial-1.jpg" alt="">
                            <div>
                                <h5>Maricruz Ramirez</h5>
                    ...
                    <form action="https://formsubmit.co/joey_quiros13@hotmail.com" method="POST">
                        <div class="row">
                            <div class="col-6 form-group">
                                <input type="text" class="form-control border-top-0 border-right-0 border-left-0 p-0" placeholder="Nombre" required="required" name="name">
                            </div>
                            <div class="col-6 form-group">
                                <input type="email" class="form-control border-top-0 border-right-0 border-left-0 p-0" placeholder="Correo" required="required" name="email">
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control border-top-0 border-right-0 border-left-0 p-0" placeholder="Asunto" required="required" name="asunto">
                        </div>
                        <div class="form-group">
                            <textarea class="form-control border-top-0 border-right-0 border-left-0 p-0" rows="5" placeholder="Mensaje" required="required" name="mensaje"></textarea>
                        </div>
                        <div>
