                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <div class="d-grid gap-3mx-auto">
                                    ...
                                    <button class="btn btn-primary mt-1" type="button">Subir material</button>
                                    <button class="btn btn-primary mt-1" type="button">Editar Tutoria</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-5">
                    <a href="index.html" class="navbar-brand">
                        <h1 class="mt-n2 text-uppercase text-white"><img src="img/logo.svg" width="32px" height="32px"
